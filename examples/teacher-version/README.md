...
└── todoapp-backend-api-e2etest-main/ # 🧪 E2E 测试项目（本次未使用）
```

## 🎯 快速开始

1. **阅读**: 打开 [START_HERE.md](START_HERE.md)
...
**症状**: "❌ 源目录不存在: /test-projects/teacher-version"
...
- [快速开始](START_HERE.md) - 1分钟快速测试
- [详细测试指南](AGENT_TEST_GUIDE.md) - 完整测试流程
- [Docker Agent 快速指南](../../DOCKER_AGENT_QUICKSTART.md) - Agent 部署
- [.NET Agent 测试指南](../../DOTNET_AGENT_TEST_GUIDE.md) - Agent 配置
